 ...
 *
 * The version of the OpenAPI document: 1.7.27
 * 
 *
...
export const UserStorageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getList(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UserStorageDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getList(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
...
export const UserStorageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getList(options?: AxiosRequestConfig): AxiosPromise<Array<UserStorageDto>> {
            return localVarFp.getList(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserStorageApi extends BaseAPI {
     ...
     */
    public getList(options?: AxiosRequestConfig) {
        return UserStorageApiFp(this.configuration).getList(options).then((request) => request(this.axios, this.basePath));
    }
}
